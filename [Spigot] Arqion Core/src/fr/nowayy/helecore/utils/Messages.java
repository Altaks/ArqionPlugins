...
public enum Messages {
	...
	Error_WorldDontExists			("§cLe monde §e{@WorldName} §cn'existe pas !"),
	...
	PlayerInfo_CannotInspect		("§cVous ne pouvez pas inspecter le joueur �§{@target}"),
	...
	KillAll_All						("§aToutes les entités ont été tuées."),
	KillAll_HostilesEntities		("§aToutes les entités hostiles ont été tuées."),
	KillAll_AnimalsEntities			("§aTous les animaux ont été tués."),
	KillAll_MinecartEntities		("§aTous les minecarts ont été détruits."),
	KillAll_ArrowEntities			("§aToutes les flèches au sol ont disparues;"),
