...
public class ShopItem {
	...
	public static final ItemStack barrier = new ItemBuilder(Material.BARRIER, 1, (short)0, "�cQuitter").build(), glasspane = new ItemBuilder(Material.GRAY_STAINED_GLASS_PANE, 1, (short)0, " ").build(), returnArrow = new ItemBuilder(Material.ARROW,1, (short)0, "�cRetour en arri�re").build();
